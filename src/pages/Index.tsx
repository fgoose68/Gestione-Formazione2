      ...
      <div className="relative z-10 w-full max-w-md px-8 py-10 bg-white/90 backdrop-blur-sm rounded-xl shadow-xl mx-4">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-gray-600">
            {isLogin ? 'Sign in to access your dashboard' : 'Get started with your account'}
          </p>
        </div>
        ...
        <form onSubmit={handleAuth} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-3 px-4 rounded-lg font-medium text-white transition ${loading ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'} focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2`}
          >
            {loading ? (
